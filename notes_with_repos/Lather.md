...
- [shrutikapoor08/devjoke](https://github.com/shrutikapoor08/devjoke) ★1040 — #DevJoke. Submit a PR if you know a good dev joke. 
- [rochacbruno/rust-python-example](https://github.com/rochacbruno/rust-python-example) ★789 — Example of using Rust to Extend Python
- [RedBearAK/Toshy](https://github.com/RedBearAK/Toshy) ★650 — Keymapper config to make Linux keyboard shortcuts work like a 'Tosh! And more. (A Kinto alternative.)
- [udacity/frontend-nanodegree-mobile-portfolio](https://github.com/udacity/frontend-nanodegree-mobile-portfolio) ★338 — 
- [jennybc/here_here](https://github.com/jennybc/here_here) ★317 — I love the here package. Here's why.
...
## Related Links
- Google Scholar: https://scholar.google.com/scholar?q=Lather
