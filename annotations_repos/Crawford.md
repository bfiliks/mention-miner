...
- [requarks/wiki](https://github.com/requarks/wiki) ★26995 — Wiki.js | A modern and powerful wiki app built on Node.js
- [mail-in-a-box/mailinabox](https://github.com/mail-in-a-box/mailinabox) ★14897 — Mail-in-a-Box helps individuals take back control of their email by defining a one-click, easy-to-deploy SMTP+everything else server: a mail server in a box.
- [ange-yaghi/engine-sim](https://github.com/ange-yaghi/engine-sim) ★9083 — Combustion engine simulator that generates realistic audio.
- [wilsonpage/fastdom](https://github.com/wilsonpage/fastdom) ★6916 — Eliminates layout thrashing by batching DOM measurement and mutation tasks
- [ErikCH/DevYouTubeList](https://github.com/ErikCH/DevYouTubeList) ★5044 — List of Development YouTube Channels
...
## Related Links
- Google Scholar: https://scholar.google.com/scholar?q=Crawford
